...
imgMiss = Image.open('lib/targetMiss.png')
imgHit = Image.open('lib/targetFind.png')
...
orig_dir = '/Users/shighton/eclipse-workspace/rnaML/src/rnaML/trainML'
base_dir = '/Users/shighton/eclipse-workspace/rnaML/src/rnaML/binaryClassRNA'
